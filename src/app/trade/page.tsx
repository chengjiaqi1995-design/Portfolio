...
import type { PositionWithRelations, TradeItemInput, PortfolioSummary } from "@/lib/types";
...
export default function TradePage() {
  ...
  async function handleDownloadExcel() {
    if (!tradeId) return;
    try {
      const res = await fetch(`/api/trades/${tradeId}/export`);
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">调仓</h1>
